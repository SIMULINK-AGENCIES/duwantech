                            ...
                            <div class="flex items-center justify-between py-2">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <a href="{{ route('admin.dashboard') }}" 
                                       class="inline-flex items-center px-3 py-1 border border-gray-600 rounded-md text-xs font-medium text-white bg-gray-800 hover:bg-gray-700 transition-colors">
